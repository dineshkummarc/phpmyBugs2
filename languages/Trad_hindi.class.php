...
const S_UPGRADE = '<a href="'.RELEASE.'">गिटहब</a> से <a href="'.UPGRADE.'">अपग्रेड</a> तक नवीनतम संस्करण प्राप्त करें.';
...
const A_IE = 'आपका ब्राउज़र पुराना हो गया है: <a href="'.BROWSER.'">इसे अपग्रेड करें या बदलें</a>.';
...
const F_TIP_URL_CDN = 'CDN को अक्षम करने के लिए इस फ़ील्ड को खाली छोड़ दें। अन्यथा, इसमें आपके सीडीएन का यूआरएल होना चाहिए (उदाहरण के लिए <em>'.CDN_RAW_GIT.'</em>, इसे इस्तेमाल करने में संकोच न करें)। अपने सीडीएन पर <em>/public</em> फ़ोल्डर से सभी फ़ाइलों को होस्ट करना सुनिश्चित करें।';
