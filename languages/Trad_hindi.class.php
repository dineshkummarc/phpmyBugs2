...
const W_RSS = 'RSS फ़ीड';
const W_VERSION = 'संस्करण';
const W_CAPTCHA_IMAGE = 'CAPTCHA छवि';
...
const S_UPGRADE = '<a href="https://github.com/bugtrackr/Nireus/releases/latest">GitHub</a> से <a href="https://bugtrackr.github.io/wiki/upgrade/">अपग्रेड</a> तक नवीनतम संस्करण प्राप्त करें.';
...
const A_SUCCESS_INSTALL = '<strong>संपन्न:</strong> phpmyBugs अब पूरी तरह से कॉन्फ़िगर हो गया है।';
const A_ERROR_INSTALL = '<strong>त्रुटि:</strong> phpmyBugs पहले से ही कॉन्फ़िगर हो गया है। यदि आप कॉन्फ़िगरेशन को रीसेट करना चाहते हैं तो कृपया कॉन्फ़िगरेशन फ़ाइल को हटा दें।';
...
const T_API_ENABLE_SETTINGS = 'API प्रबंधित करें';
const T_API_ACCESS_SETTINGS = 'API एक्सेस';
...
const F_INVALID_CAPTCHA = 'आपके द्वारा दर्ज किया गया CAPTCHA गलत था। कृपया पुनः प्रयास करें।';
const F_TIP_NAME = 'यह प्रत्येक पृष्ठ के शीर्षलेख पर प्रदर्शित होगा।';
const F_TIP_URL_REWRITING = 'URL पुनर्लेखन को अक्षम करने के लिए इस फ़ील्ड को खाली छोड़ दें। अन्यथा, इसमें डोमेन नाम के सापेक्ष phpmyBugs फ़ोल्डर (एक "/" के साथ शुरू और समाप्त) का पथ होना चाहिए।';
const F_TIP_URL_CDN = 'CDN को अक्षम करने के लिए इस फ़ील्ड को खाली छोड़ दें। अन्यथा, इसमें आपके CDN का URL होना चाहिए (उदाहरण के लिए <em>https://cdn.rawgit.com/bugtrackr/Nireus/master/</em>, इसे इस्तेमाल करने में संकोच न करें)। अपने CDN पर <em>/public</em> फ़ोल्डर से सभी फ़ाइलों को होस्ट करना सुनिश्चित करें।';
...
const F_TIP_API_ACCESS = '<em>/database/config_api.php</em> फ़ाइल में API एक्सेस कॉन्फ़िगर करें। अधिक जानकारी के लिए API.md फ़ाइल देखें।';

const F_API_ENABLE = 'API सक्षम करें';
...
'private_label_removed' => 'आप निजी लेबल को हटा नहीं सकते या उसकी ID नहीं बदल सकते, लेकिन आप उसका नाम बदल सकते हैं.',

'default_status_removed' => 'आप डिफ़ॉल्ट स्थिति को हटा नहीं सकते या उसकी ID नहीं बदल सकते, लेकिन आप उसका नाम बदल सकते हैं.',

'default_group_removed' => 'आप डिफ़ॉल्ट समूह को हटा नहीं सकते या उसकी ID नहीं बदल सकते, लेकिन आप उसका नाम बदल सकते हैं.',

'default_group_superuser_removed' => 'आप सुपरयूज़र समूह को हटा नहीं सकते या उसकी ID नहीं बदल सकते, लेकिन आप उसका नाम बदल सकते हैं.',
