...
const S_UPGRADE = 'Получить последнюю версию с <a href="https://github.com/bugtrackr/Nireus/releases/latest">GitHub</a> для <a href="https://bugtrackr.github.io/wiki/upgrade/">обновления</a>.';
...
const A_IE = 'Ваш браузер устарел: <a href="https://www.browser-update.org/en/update.html">обновите или измените его</a>.';
...
const F_TIP_URL_CDN = 'Оставьте это поле пустым, чтобы отключить CDN. В противном случае он должен содержать URL-адрес вашего CDN (например, <em>https://cdn.rawgit.com/bugtrackr/Nireus/master/</em>, можете использовать этот). Обязательно разместите все файлы из папки <em>/public</em> на вашем CDN.';
