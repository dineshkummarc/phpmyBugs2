...
const A_SUCCESS_DELETE_ISSUE = 'Masalah telah dihapus.'; const A_CONFIRM_DELETE_UPLOAD = 'Apakah Anda yakin ingin menghapus berkas ini?';
...
const A_PLEASE_LOGIN_ISSUE = 'Silakan masuk untuk mengirim masalah. Belum punya akun? Buat satu: gratis dan sangat cepat!'; const A_SHOULD_LOGIN = 'Jika Anda memiliki akun, silakan masuk. Jika tidak, pertimbangkan untuk membuatnya: gratis dan sangat cepat!';
...
const T_GROUPS = 'Grup'; const T_USERS = 'Pengguna'; const T_PERMISSIONS = 'Izin'; const T_ENABLE_CAPTCHA = 'Kelola Captcha'; const T_CAPTCHA = 'Captcha'; const T_BROWSE_ISSUES = 'Telusuri masalah'; const T_BROWSE_ALL_ISSUES = 'Telusuri semua masalah'; const T_ALL_ISSUES_DESCRIPTION = 'Ini semua adalah masalah terbuka untuk semua proyek'; const T_NEW_ISSUE = 'Masalah baru'; const T_ALL_ISSUES = 'Semua masalah'; const T_PROJECTS = 'Proyek'; const T_DASHBOARD = 'Dasbor'; const T_LAST_UPDATES = 'Pembaruan terakhir'; const T_LAST_ACTIVITY = 'Aktivitas terakhir'; const T_UPLOADS = 'Unggahan'; const T_SEARCH = 'Pencarian'; const T_LINK_CONTACT = 'Hubungi Kami'; const T_LINK_LEGALNOTICE = 'Pemberitahuan Hukum'; const T_LINK_PRIVACYPOLICY = 'Kebijakan Privasi'; const T_API_SETTINGS = 'API'; const T_API_ENABLE_SETTINGS = 'Kelola API'; const T_API_ACCESS_SETTINGS = 'Akses API'; const T_INFO = 'Info'; # FORMULIR const F_USERNAME = 'Nama Pengguna:'; const F_PASSWORD = 'Kata Sandi:'; const F_USERNAME2 = 'Nama Pengguna'; const F_PASSWORD2 = 'Kata Sandi'; const F_NAME = 'Nama:'; const F_URL = 'Url:'; const F_URL_CDN = 'Url CDN:'; const F_URL_REWRITING = 'Penulisan ulang url:'; const F_INTRO = 'Pendahuluan:'; const F_DESCRIPTION = 'Deskripsi:'; const F_EMAIL = 'Email:'; constF_LINK_CONTACT = 'Tautan ke halaman kontak eksternal (dapat dibiarkan kosong):';
...
const F_LOGS = 'Log:';
const F_ISSUES_PAGE = 'Masalah per halaman:'; const F_ISSUES_PAGE_SEARCH = 'Masalah per halaman (pencarian):';
...
const F_ADD_STATUS = 'Status baru'; const F_ADD_LABEL = 'Label baru'; const F_ADD_GROUP = 'Grup baru'; const F_ADD_USER = 'Pengguna baru'; const F_SORT_BY = 'Urutkan berdasarkan:'; const F_SORT_ID = 'ID'; const F_SORT_MOD = 'pembaruan terakhir'; const F_SORT_DESC = 'menurun'; const F_SORT_ASC = 'menaik'; const F_FILTER_STATUSES = 'Status filter:'; const F_FILTER_STATES = 'Status filter:'; const F_FILTER_LABELS = 'Label filter:'; const F_FILTER_USERS = 'Filter pengguna:'; const F_FILTER_MILESTONE = 'Tonggak pencapaian filter:'; const F_WRITE = 'Tulis:'; const F_SUMMARY = 'Ringkasan'; const F_CONTENT = 'Konten'; const F_STATUS = 'Status:'; const F_RELATED = 'Terkait:'; const F_LABELS2 = 'Label:'; const F_MILESTONE = 'Tonggak:'; const F_GENERAL_SETTINGS = 'Pengaturan umum:'; const F_PROJECTS = 'Proyek:'; const F_DATABASE = 'Basis data:'; const F_UPLOADS = 'Unggahan:'; const F_COLORS = 'Kelola warna:'; const F_DISPLAY = 'Kelola tampilan:'; const F_STATUSES = 'Kelola status:'; const F_LABELS = 'Kelola label:'; const F_GROUPS = 'Kelola grup:';
...
const F_TIP_NOTIFICATIONS = 'Ini adalah pengaturan default: Anda dapat mengubahnya untuk setiap masalah.'; const F_TIP_NOTIFICATIONS_DISABLED = 'Catatan: notifikasi saat ini dinonaktifkan oleh administrator.';
...
const F_TIP_ID_STATUS = '<b>Tips:</b> berhati-hatilah saat mengubah ID, karena setiap masalah tetap mempertahankan ID status lamanya (kecuali jika ID ini tidak ada lagi: dalam kasus ini, status default akan digunakan).'; const F_TIP_ID_LABEL = '<b>Tips:</b> berhati-hatilah saat mengubah ID, karena setiap label dari satu masalah tetap menggunakan ID lamanya (kecuali jika ID ini tidak ada lagi: dalam kasus ini, label dihapus dari masalah tersebut).';
