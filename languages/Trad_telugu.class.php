...
class Trad {
  ...
  const S_UPGRADE = '<a href="'.RELEASE.'">GitHub</a> నుండి <a href="https://bugtrackr.github.ioకి తాజా సంస్కరణను పొందండి /wiki/upgrade/">అప్‌గ్రేడ్</a>.';
  ...
  const A_IE = 'మీ బ్రౌజర్ వాడుకలో లేదు: <a href="'.BROWSER.'">అప్‌గ్రేడ్ చేయండి లేదా మార్చండి</a>.';
...
ఇది స్వయంచాలక ఇమెయిల్, దయచేసి ప్రత్యుత్తరం ఇవ్వవద్దు.
 ...
 const T_INSTALLATION = 'ఇన్‌స్టాలేషన్';
  ...
  const F_TIP_URL_CDN = 'CDNని నిలిపివేయడానికి ఈ ఫీల్డ్‌ను ఖాళీగా వదిలేయండి. లేకపోతే, అది మీ CDN యొక్క URLని కలిగి ఉండాలి (ఉదాహరణకు <em>'.CDN_RAW_GIT.'</em>, దీన్ని ఉపయోగించడానికి సంకోచించకండి). మీ CDNలో <em>/public</em> ఫోల్డర్ నుండి అన్ని ఫైల్‌లను హోస్ట్ చేసినట్లు నిర్ధారించుకోండి.';
