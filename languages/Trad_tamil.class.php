...
class Trad {
 ...
 const S_UPGRADE = '<a href="'.RELEASE.'">GitHub</a> இலிருந்து <a href="https://bugtrackr.github.io க்கு சமீபத்திய பதிப்பைப் பெறவும் / wiki/upgrade/">மேம்படுத்து</a>.';
 ...
 const A_IE = 'உங்கள் உலாவி காலாவதியானது: <a href="'.BROWSER.'">மேம்படுத்தவும் அல்லது மாற்றவும்</a>.';
...
இது ஒரு தானியங்கி மின்னஞ்சல், தயவுசெய்து பதிலளிக்க வேண்டாம்.
 ...
 const F_TIP_URL_CDN = 'CDN ஐ முடக்க இந்த புலத்தை காலியாக விடவும். இல்லையெனில், அதில் உங்கள் CDNன் URL இருக்க வேண்டும் (உதாரணமாக <em>'.CDN_RAW_GIT.'</em>, இதைப் பயன்படுத்த தயங்க வேண்டாம்). உங்கள் CDN இல் உள்ள <em>/public</em> கோப்புறையிலிருந்து எல்லா கோப்புகளையும் ஹோஸ்ட் செய்வதை உறுதி செய்து கொள்ளவும்.';
