...
```</code></pre>
 ';
  ...
  தனிப்பட்ட நிலையான $அனுமதிகள் = வரிசை(
 'முகப்பு' => வரிசை(
 'title' => 'முகப்பு:',
 ...
 பொது நிலையான செயல்பாடு அனுமதிகள்($id, $type = 'விளக்கம்') {
 திரும்பவும்::$permissions[$id][$type];
 }

 தனிப்பட்ட நிலையான $அமைப்புகள் = வரிசை(
 ...
 'language_modified' => 'புதிய மொழியில் பார்க்க இந்தப் பக்கத்தைப் புதுப்பிக்கவும்.'
  ...
  பொது நிலையான செயல்பாடு அமைப்புகள்($id) {
 திரும்பவும்::$settings[$id];
 }

 தனிப்பட்ட நிலையான $ பிழைகள் = வரிசை(
 ...
 பொது நிலையான செயல்பாடு பிழைகள் ($இல்லை) {
  திரும்ப (isset(self::$errors[$no])) ? self::$errors[$no] : self::$errors['default'];
 }
}
