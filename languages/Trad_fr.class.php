...
class Trad {
	...
	const S_INTRO_INSTALL = 'On dirait que c\'est la première fois que vous utilisez RHS Issue Tracker ! Merci de le configurer :';
	...
	const A_SUCCESS_INSTALL = '<strong>Terminé :</strong> RHS Issue Tracker est maintenant configuré.';
	const A_ERROR_INSTALL = '<strong>Erreur :</strong> RHS Issue Tracker est déjà configuré. Si vous souhaitez revenir à la configuration par défaut, supprimez le fichier de configuration.';
...
Ceci est un message automatisé. Merci de ne pas y répondre.
	...
	const F_TIP_URL_REWRITING = 'Laissez ce champ vide pour désactiver l\'url rewriting. Sinon, il doit contenir le chemin du dossier de RHS Issue Tracker (en commençant et terminant par un "/") par rapport au nom de domaine.';
