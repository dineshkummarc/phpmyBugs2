...
class Trad {
  ...
  const A_IE = 'আপনার ব্রাউজার অপ্রচলিত: <a href="'.BROWSER.'">আপগ্রেড বা পরিবর্তন করুন</a>।';
...
এটি একটি স্বয়ংক্রিয় ইমেল, দয়া করে উত্তর দেবেন না।
 ...
 const T_INSTALLATION = 'ইনস্টলেশন';
  ...
  const F_TIP_URL_CDN = 'CDN নিষ্ক্রিয় করতে এই ক্ষেত্রটি খালি রাখুন। অন্যথায়, এতে আপনার CDN এর URL থাকতে হবে (উদাহরণস্বরূপ <em>'.CDN_RAW_GIT.'</em>, এটি ব্যবহার করতে দ্বিধা বোধ করুন)। আপনার CDN এ <em>/public</em> ফোল্ডার থেকে সমস্ত ফাইল হোস্ট করা নিশ্চিত করুন৷';
