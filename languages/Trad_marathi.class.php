...
const S_UPGRADE = '<a href="'.RELEASE.'">Github</a> to <a href="https://bugtrackr.github.io/wiki/upgrade "/">अपग्रेड होईपर्यंत नवीनतम आवृत्ती मिळवा</a>.';
...
const A_IE = 'तुमचा ब्राउझर कालबाह्य झाला आहे: <a href="'.BROWSER.'">त्याला अपग्रेड करा किंवा बदला</a>.';
...
const F_TIP_URL_CDN = 'CDN अक्षम करण्यासाठी हे क्षेत्र रिकामे सोडा. अन्यथा, त्यात तुमच्या CDN ची URL असावी (उदाहरणार्थ <em>'.CDN_RAW_GIT.'</em>, मोकळ्या मनाने हे वापरा). तुमच्या CDN वरील <em>/public</em> फोल्डरमधून सर्व फाइल्स होस्ट केल्याचे सुनिश्चित करा.';
