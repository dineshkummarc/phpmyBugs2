...
class Trad {
  ...
  const S_UPGRADE = '<a href="'.RELEASE.'">GitHub</a> ਤੋਂ <a href="https://bugtrackr.github.io ਤੱਕ ਨਵੀਨਤਮ ਸੰਸਕਰਣ ਪ੍ਰਾਪਤ ਕਰੋ /wiki/upgrade/">ਅੱਪਗ੍ਰੇਡ ਕਰੋ</a>।';
  ...
  const A_IE = 'ਤੁਹਾਡਾ ਬ੍ਰਾਊਜ਼ਰ ਪੁਰਾਣਾ ਹੈ: <a href="'.BROWSER.'">ਇਸ ਨੂੰ ਅੱਪਗ੍ਰੇਡ ਕਰੋ ਜਾਂ ਬਦਲੋ</a>।';
...
ਇਹ ਇੱਕ ਸਵੈਚਲਿਤ ਈਮੇਲ ਹੈ, ਕਿਰਪਾ ਕਰਕੇ ਜਵਾਬ ਨਾ ਦਿਓ।
 ...
 const T_INSTALLATION = 'ਇੰਸਟਾਲੇਸ਼ਨ';
  ...
  const F_TIP_URL_CDN = 'CDN ਨੂੰ ਅਯੋਗ ਕਰਨ ਲਈ ਇਸ ਖੇਤਰ ਨੂੰ ਖਾਲੀ ਛੱਡੋ। ਨਹੀਂ ਤਾਂ, ਇਸ ਵਿੱਚ ਤੁਹਾਡੇ CDN ਦਾ URL ਹੋਣਾ ਚਾਹੀਦਾ ਹੈ (ਉਦਾਹਰਨ ਲਈ <em>'.CDN_RAW_GIT.'</em>, ਇਸਦੀ ਵਰਤੋਂ ਕਰਨ ਲਈ ਸੁਤੰਤਰ ਮਹਿਸੂਸ ਕਰੋ)। ਆਪਣੇ CDN \'ਤੇ <em>/public</em> ਫੋਲਡਰ ਤੋਂ ਸਾਰੀਆਂ ਫਾਈਲਾਂ ਨੂੰ ਹੋਸਟ ਕਰਨਾ ਯਕੀਨੀ ਬਣਾਓ।';
