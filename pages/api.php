...
if(!file_exists(DIR_DATABASE."config_api.php")){
	$returns['status'] = 0;
	$returns['statusDetails'] = "Configuration file is missing. Check out the documentation ".API." and example configuration ".URL."/blob/master/sample_config/config_api.php for the API.";
	endApi( $returns, 500 );
}
